...
class SparkPlusMembershipCreditPage extends StatefulWidget {
  const SparkPlusMembershipCreditPage({super.key});

  @override
  State<SparkPlusMembershipCreditPage> createState() => _SparkPlusMembershipCreditPageState();
}

class _SparkPlusMembershipCreditPageState extends State<SparkPlusMembershipCreditPage> {
  @override
  Widget build(BuildContext context) {
    MembershipCreditViewModel model = context.watch<MembershipCreditViewModel>();
    MembershipMainViewModel main = context.watch<MembershipMainViewModel>();
    MembershipPhoneInputViewModel phone = context.watch<MembershipPhoneInputViewModel>();
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                                model.callProccessAPI(args, context, main, phone);
                              },
                              child: Container(
                                width: 325,
                                height: 211,
